use crate::{Position, RopeExt as _, Selection, Text};
use std::cmp::{max, min};

pub struct Buffer<'world> {
    pub text: &'world Text,
    pub selection: &'world Selection,
}

pub struct BufferMut<'world> {
    pub text: &'world mut Text,
    pub selection: &'world mut Selection,
}
